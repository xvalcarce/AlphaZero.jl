module Examples
  ...
  include("../games/circuit-synthesis/main.jl")
  export CircuitSynthesis
  ...
  const games = Dict(
	...
	"circuit-synthesis" => CircuitSynthesis.GameSpec())
  ...
  const experiments = Dict(
	...
	"circuit-synthesis" => CircuitSynthesis.Training.experiment)
